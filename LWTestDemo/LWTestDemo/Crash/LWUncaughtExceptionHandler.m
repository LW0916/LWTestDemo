...
void HandleException(NSException *exception)
{
    ...
    NSArray *callStack = [LWUncaughtExceptionHandler backtrace];
    ...
    [[[LWUncaughtExceptionHandler alloc] init]
...
@implementation LWUncaughtExceptionHandler
